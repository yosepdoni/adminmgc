                ...
                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                  ...
                  <thead>
                    ...
                    // tampilkan data yang sesuai dengan range tanggal yang dicari 
                      $data = mysqli_query($conn, "SELECT * FROM checkout WHERE tgl BETWEEN '$tanggal_awal' and '$tanggal_akhir' AND status_pengiriman ='diterima'");
                      }else{
                          // $data = mysqli_query($conn, "select * from checkout ORDER BY order_id ASC");
                          $data = mysqli_query($conn, "select * from checkout where status_pengiriman ='diterima' ORDER BY order_id ASC");
                      }
                          $no =1;
